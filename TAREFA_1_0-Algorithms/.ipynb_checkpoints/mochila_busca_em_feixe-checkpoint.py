...
def funcao_avaliacao(mochila: list, capacidade: int, num_items: int):
...
def busca_em_feixe(mochilas):
    ...
    for iteracao in range(num_iteracoes):
        ...
        for candidato in feixe:
            ...
            melhores = {}
            for v in vizinhos:
                melhores[v] = funcao_avaliacao(mochilas[v], capacidade_mochila, items)
        ...
        for v in novos_feixes:
            novos[v] = funcao_avaliacao(mochilas[v], 10, 5)
    ...
    melhores_candidatos = {}
    for candidato in feixe:
        melhores_candidatos[candidato] = funcao_avaliacao(mochilas[candidato], capacidade_mochila, items)
